...
Maps.init = function()
  ...
  local function new_notebook(filename)
    ...
    if file then
      ...
      print("Error: Could not open new notebook file!")
    end
  end

  vim.api.nvim_create_user_command('NewNotebook', function(opts) new_notebook(opts.args) end, { nargs = 1, complete = 'file' })
